...
for vertice_queimado in lista_queimados:
    defendidos_atual = vertices_dos_bombeiros(matriz_adj, qnt_vertices, vertice_queimado, lista_queimados, num_bombeiros)
    for defendido in defendidos_atual:
        if defendido not in lista_defendidos:
            lista_defendidos.append(defendido)
    lista_queimados_proximo = proximos_queimados(qnt_vertices, matriz_adj, vertice_queimado, lista_queimados)
